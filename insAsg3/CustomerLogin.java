...
public class CustomerLogin extends JFrame {
	...
	public CustomerLogin() {
		...
		LoginButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JTable t = FirstTimeLogin.getTable();
				String un;
				String pw;
				boolean login = false;
		...
		btnFirstTimeLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FirstTimeLogin f = new FirstTimeLogin();
		...
		lblBowling.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\13278508_G.jpg"));
