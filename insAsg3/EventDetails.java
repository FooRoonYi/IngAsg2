...
public class EventDetails extends JFrame {
	...
	public EventDetails() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\bowling-vector-icon-260nw-1350995225.jpg"));
		...
		EventComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int SelectedRowIndex = u.table.getSelectedRow();
				
				String t = u.table.getModel().getValueAt(SelectedRowIndex, 0).toString();
				for(int i = 0; i<EventComboBox.getItemCount(); i++) {
					if(EventComboBox.getItemAt(i).toString().equals(t)) {
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(register == true) {
					...
					CustomerRegistration r = new CustomerRegistration(); //call another window or frame
