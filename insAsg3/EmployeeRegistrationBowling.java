...
public class EmployeeRegistrationBowling extends JFrame {
	...
	public EmployeeRegistrationBowling() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\2735734-200.png"));
		...
		btnUpload.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
				File file = new File("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\EmployeeInfoSystem.txt");
				if(!file.exists()) {
					file.createNewFile();
					}
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\bigstock_bowling_strike_icon_realistic_253910683.jpg"));
