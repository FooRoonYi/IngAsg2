...
public class MarketingDetails extends JFrame {

	private JPanel contentPane;
	private Image img_close = new ImageIcon(UserOption.class.getResource("closebtn.jpeg")).getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MarketingDetails frame = new MarketingDetails();
	...
	public MarketingDetails() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\ballandpins.jpg"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\five-white-bowling-pins-260nw-285728342.jpg"));
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\candlepin-bowling.jpg"));
		...
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\images.jpg"));
