...
public class Marketing extends JFrame {
	...
	public Marketing() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\12.jpg"));
		lblNewLabel.setBounds(659, 399, 307, 295);
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\3.jpg"));
		...
		btnDetails.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MarketingDetails md = new MarketingDetails();
