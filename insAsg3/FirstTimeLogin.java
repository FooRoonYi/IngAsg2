...
import AddDropSystem.userprofile;
...
public class FirstTimeLogin extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FirstTimeLogin frame = new FirstTimeLogin();
	...
	public FirstTimeLogin() {
		...
		btnUpload.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
				File file = new File("C:\\Users\\User\\eclipse-workspace\\P2 Project\\P2 project\\FirstTimeLoginInfo.txt");
				if(!file.exists()) {
					file.createNewFile();
					}
